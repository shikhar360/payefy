...
export default function Navbar() {
  ...
  return (
    <nav className=" z-50 w-full bg-transpaent backdrop-blur-md font-mynerve font-bold   p-0 text-white font-vt text-lg flex items-start justify-between transition-all duration-300 ease-linear fixed top-0 ">
